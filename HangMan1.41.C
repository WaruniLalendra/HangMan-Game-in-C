...
#include <time.h>
/**
 *Tring to reduce used words and generate random values
 *
 *
 */
...
int main()
{
    ...
    int noOfLetters,i,countWrong,countCorrect,j,k,l,numberOfWords=4,a;
    ...
    printf("\n\n\n\t\t\tWELCOME TO HANGMAN!!!\n\n\n");
        ...
        do{
            ...
            for(a=wordIndex; a<=numberOfWords-2; a++){
                words[a] = word[a+1];
            }
            //printf("\nYou have %d words to guess!\n",numberOfWords);
            numberOfWords--;
